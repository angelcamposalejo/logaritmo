...
protected:
	...
	void GetDialogTemplate(DLGTEMPLATE& dlgTemplate)
	{
		...
		dlgTemplate.cy = Sys::Convert::PixelToDlgUnitY(594);
	...
	void InitializeGui()
	{
		...
		tbxSalida.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_MULTILINE | ES_LEFT | ES_WINNORMALCASE, 11, 59, 471, 528, hWnd, 1000);
